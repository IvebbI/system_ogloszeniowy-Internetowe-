...
if(isset($_POST['submit'])){
    ...
    if(!isset($error)){
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if ($row['zweryfikowany'] == 'TAK') { // Sprawdzamy, czy użytkownik jest zweryfikowany
                ...
                $error = 'Użytkownik nie jest jeszcze zweryfikowany!';
            }
        } else {
...
<body>
  <div class="form-container">
    ...
    <form action="" method="post">
      ...
      <div class="przywroc-haslo">Nie pamiętasz hasła?<a href="../resetpassword/" class="margin-left-10">Zresetuj hasło</a><br></div>
      <input type="submit" value="Zaloguj się!" name="submit" class="form-btn">
      <p>Nie masz konta?<a href="../registerform/" class="margin-left-10">Zarejestruj się!</a></p>
    </form>
